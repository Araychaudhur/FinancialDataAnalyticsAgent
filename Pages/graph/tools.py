...
def complete_python_task(graph_state: Annotated[dict, InjectedState], thought: str, python_code: str)-> Tuple[str, dict]:
    ...
    Args:
        ...
        python_code: Python code to be executed to perform analysis, create a new dataset or create a visualization.
    """
    ...
    try:
        ...
        exec_globals.update(persistant_vars)
        exec_globals.update(current_variables)
        exec_globals.update({"plotly_figures": []})

        exec(python_code, exec_globals)
        persistant_vars.update({k: v for k, v in exec_globals.items() if k not in globals()})
        ...
        updated_state = {
            ...
            "current_variables": persistant_vars
        }
        ...
        if 'plotly_figures' in exec_globals:
            ...
            persistant_vars["plotly_figures"] = []
